...
import (
	...
	"github.com/llqgit/pulsar-client-go/pulsar/internal/compression"
	internalcrypto "github.com/llqgit/pulsar-client-go/pulsar/internal/crypto"
	...
	"github.com/llqgit/pulsar-client-go/pulsar/log"
...
func (p *partitionProducer) failTimeoutMessages() {
	...
	for range t.C {
		...
		// see https://github.com/llqgit/pulsar-client-go/pull/301
